...
const mapDispatchToProps = (dispatch) => ({
    postFeedback:(firstname, lastname, telnum, email, contactType, message, agree)=>dispatch(postFeedback(firstname, lastname, telnum, email, contactType, message, agree)),
