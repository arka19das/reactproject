...
import { Card, CardImg, CardBody, CardText, CardTitle, Container, Breadcrumb, BreadcrumbItem } from 'reactstrap';
    ...
    const DishDetail = (props) => {
        ...
        if (props.dish != null) {
            return ( <
                ...
                div className = 'col-12 col-md-5 m-1' >
                <
                h4 > Comments < /h4> < RenderComments comments= { props.comments } / > < /
                div >
